...
<title><?php echo e(config('app.name')); ?> - Crear Categoría</title>
    ...
    <div class="col-md-12">
        <div class="card shadow">
            ...
            <div class="card-block">
                <form method="POST" action="<?php echo e(url('categories/store')); ?>" class="row">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('tenant.layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ds_webmarket\resources\views/tenant/admin/categories/create.blade.php ENDPATH**/ ?>