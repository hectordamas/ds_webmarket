...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('files/admin/style.css')); ?>">

    <input type="hidden" id="lastOrderId" value="<?php echo e($lastOrderId); ?>">
                    ...
                    <div class="navbar-container">
                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-bs-toggle="dropdown">
                                        <img src="<?php echo e(asset('assets/img/user_default.jpg')); ?>" class="img-radius"
        ...
        function notificarConSonido(titulo, mensaje, url) {
            if (Notification.permission === 'granted') {
                let noti = new Notification(titulo, {
                    body: mensaje,
                    icon: '<?php echo e(asset("assets/img/favicon.png")); ?>',
                });
                ...
                success: function (data) {
                    ...
                    nuevasOrdenes.forEach(order => {
                        notificarConSonido(
                            ...
                            `<?php echo e(url('orders/ver-detalles')); ?>/${order.id}`
                        );
                    });
