                        ...
                        <div class="row m-t-25 text-start">
                            <div class="col-12 d-flex justify-content-between align-items-center">
                                ...
                                <div class="forgot-phone text-end f-right">
                                    <a href="<?php echo e(url('password/forgot')); ?>" class="f-w-600">¿Olvidaste tu contraseña?</a>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('tenant.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dswebmarket\resources\views/auth/tenant/login.blade.php ENDPATH**/ ?>