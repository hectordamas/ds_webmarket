        ...
        <div class="col-sm-12">
            <form class="md-float-material form-material" method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <div class="text-center mb-3">
                    <img src="<?php echo e(asset('central/assets/img/logo-light.png')); ?>" alt="Logo <?php echo e(env('APP_NAME')); ?>" width="180">
                </div>
...
<?php echo $__env->make('central.layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ds_webmarket\resources\views/auth/login.blade.php ENDPATH**/ ?>