...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="row">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-12 pt-4 pb-3 category-title" id="<?php echo e($item->slug); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="card mb-3 shadow border-0 product-card" data-name="<?php echo e($product->name); ?>">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-8 d-flex flex-column justify-content-between">
                                        ...
                                        <div class="d-flex justify-content-start align-items-center">
                                            ...
                                            <span class="mx-2 price text-tenant">$<?php echo e(number_format($product->price, 2, '.', ',')); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-4">
                ...
                <div class="container text-center">
                    <div class="mb-2">
                        ...
                        <?php if(isset($settings['instagram'])): ?>
                            <a href="<?php echo e($settings['instagram']); ?>" class="text-light mx-2"><i class="fab fa-instagram"></i></a>
                        <?php endif; ?>

                        <?php if(isset($settings['whatsapp_url'])): ?>
                            <a href="<?php echo e($settings['whatsapp_url']); ?>" class="text-light mx-2"><i class="fab fa-whatsapp"></i></a>
                        <?php endif; ?>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.show-product-btn', function() {
            ...
            // Hacer petición AJAX
            $.ajax({
                url: '<?php echo e(url("products")); ?>/' + productId + "/show",
                type: 'GET',
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    Swal.fire({
                        ...
                        confirmButtonColor: "<?php echo e($settings['color_primary'] ?? '#198754'); ?>", // o usa el color del tenant
                ...
                if(response.error){
                    Swal.fire({
                        icon: "error", 
                        text: response.error,
                        confirmButtonColor: "<?php echo e($settings['color_primary'] ?? '#198754'); ?>",
...
<script>
  $('#btnConfirmar').on('click', function() {
    ...
    $.ajax({
      url: "<?php echo e(url('orders/store')); ?>",
      method: 'POST',
      data: data,
      beforeSend: function() {
...
$(document).on('click', '#enviarWhatsapp', function(e) {
    ...
    $.ajax({
        url: "<?php echo e(url('enviar-pedido')); ?>",
        method: "POST",
        data: data,
        beforeSend: function() {
...
<?php echo $__env->make('tenant.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\dswebmarket\resources\views/tenant/shop/index.blade.php ENDPATH**/ ?>