...
<title>Editar Tenant - <?php echo e(config('app.name')); ?></title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<form action="<?php echo e(route('tenants.update', $tenant->id)); ?>" method="POST" class="card shadow mb-4" enctype="multipart/form-data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Botón para eliminar -->
                                    <form action="<?php echo e(url('tenant/users/destroy')); ?>" method="POST" class="d-inline" onsubmit="return confirm('¿Estás seguro de eliminar este usuario?')">
                                        <?php echo csrf_field(); ?>
...
<div class="modal fade" id="createUserModal" tabindex="-1" aria-labelledby="crateUserModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <form id="createUserForm" method="POST" action="<?php echo e(url('tenant/users/store')); ?>">
        <?php echo csrf_field(); ?>
