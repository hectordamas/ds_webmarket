...
<?php $__env->startSection('styles'); ?>
  <link rel="stylesheet" href="<?php echo e(asset('landing/assets/css/plugins.css')); ?>">
  <link rel="stylesheet" href="<?php echo e(asset('landing/assets/css/style.css')); ?>">
  <link rel="preload" href="<?php echo e(asset('landing/assets/css/fonts/dm.css')); ?>" as="style" onload="this.rel='stylesheet'">
        ...
        <div class="col-lg-6">
          <div class="card shadow-lg border-0 rounded-4 p-4" data-cue="slideInUp" data-delay="600">
            <div class="text-center my-5">
              <img src="<?php echo e(asset('central/assets/img/logo-color.png')); ?>" alt="DS WebMarket" style="aspect-ratio: auto; object-fit: contain; width: 180px;">
              <h5 class="mt-3">💚 ¡Prueba gratis por 3 días!</h5>
            </div>

            <form method="POST" action="<?php echo e(url('solicitudes/store')); ?>" class="row g-3">
              <?php echo csrf_field(); ?>
              <div class="col-md-6">
              ...
              <div class="col-12 my-4">
                ...
                <div class="text-center">
                    <img src="<?php echo e(asset('central/assets/img/saint-light.png')); ?>" 
                         class="me-1 recolor-logo" 
                         alt="Saint" style="aspect-ratio: auto; object-fit: contain; width: 100px;">

                    <img src="<?php echo e(asset('central/assets/img/dsapps.png')); ?>" 
                         class="recolor-logo" 
...
<?php $__env->startSection('scripts'); ?>
  ...
  <script src="<?php echo e(asset('landing/assets/js/plugins.js')); ?>"></script>
  <script src="<?php echo e(asset('landing/assets/js/theme.js')); ?>"></script>
<?php $__env->stopSection(); ?>
