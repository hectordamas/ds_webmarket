...
@section('metadata')
<title>Crear Tenant - {{ config('app.name') }} </title>
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
            ...
            <div class="card-block">
                ...
                <form action="{{ route('tenants.store') }}" method="POST" class="row">
                    ...
                    <div class="form-group col-md-3 mb-3">
                        ...
                        <input type="date" name="fecha_vencimiento" id="fecha_vencimiento" class="form-control" value="{{ \Carbon\Carbon::now()->addYear()->format('Y-m-d') }}" required>
                    </div>
                    <div class="form-group col-md-3 mb-3">
