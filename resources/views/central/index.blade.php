...
<div class="container">
    <div class="row d-flex justify-content-center">
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12 py-3 mt-2 text-center">
                    <img src="{{ asset('central/assets/img/logo-light.png') }}" alt="" style="max-width: 250px; max-height: 200px;">
                </div>
        ...
        <div class="col-md-12 text-center">
            <div class="my-4">
                <img src="{{ asset('central/assets/img/saint-light.png') }}" style="max-width: 100px;" alt="">
                <img src="{{ asset('central/assets/img/dsapps.png') }}" style="max-width: 100px;" alt="">
            </div>
        </div>
    </div>
</div>
